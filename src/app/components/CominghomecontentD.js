    ...
    return(
        ...
        <div className='appcontainer'>
            ...
            <div className='GroupParallax parallaxgroup'>
                ...
                <div className="parallaxlayer startlayer">
                    <motion.div 
                        initial={{opacity: 0}}
                        animate={{opacity: 1}}
                        transition={{duration: 2, delay:1.75, ease: "easeInOut"}}
           ...
           <div className='GroupParallax parallaxgroupS'>
            ...
            <div className='GroupParallax parallaxgroup'>
                <div className="parallaxlayer midlayer">
                    <div className='contpaneltxtC mgntop5'>
                        <div className="apptxtFrontW">
                            <h1>
            ...
            <div className="GroupParallax parallaxgroup">
                ...
                <div className="parallaxlayer midlayer">
                    <div className="contentpanel mgntop10">
                        <div className='contpaneltxtA'>
                            <div className="apptxtFrontW">
                                <h1>
                                    60’s Scoop
            ...
            <div className='GroupParallax parallaxgroupL'>
                <div className="parallaxlayer baselayer">
                <Image
                    src={MedicineBundle}
                    alt="bundle"
                ...
                <div className="parallaxlayer startlayer">
                    <div className="contentpanel mgntop40">
                        <motion.div 
                            variants={variantstxt}
                            initial={'hidden'}
                            whileInView={'visible'}
            ...
            <div className="`GroupParallax parallaxgroupM">
                <div className="parallaxspacer"/>
            </div>
            <div className='GroupParallax parallaxgroup'>
                <div className="parallaxlayer midlayer">
            ...
            <div className='GroupParallax parallaxgroup'>
                <div className="parallaxlayer farlayer">
                    <motion.div 
                        ...
                        whileInView={'visible'}
                        transition={{duration: 1.2, ease: "easeInOut"}}
                        className="contpanelimgB mgntop10"
                    >
                        <Image 
...
{/* changeOut */}
            ...
            <div className='GroupTop parallaxgroup'>
                <div className="parallaxlayer caplayer">
                    <div className='flexpaneldisplay'>
                        <div className='topLayeritembtn' id='artprofileD'>
                            <Link href="/pages/ArtistProfileD" className="apptextB" style={{textDecoration:'none'}}>
                                <Image
            ...
            <div className='GroupTop parallaxgroup' id="docvidDII">
                <div className="parallaxlayer startlayer flexpaneldisplay">
                    <div className="topLayeritemVid">
            ...
            <div className='GroupParallax parallaxgroup' id="gatherings">
                <div className="parallaxlayer baselayer">
                    <div className='svgcontain'>
                        <Image
                            src={Teacher}
            ...
            <div className="GroupParallax parallaxgroup">
                <div className="parallaxlayer startlayer mgntop60">
                    <div className="contentpanel">
                        <motion.div 
                            variants={variantstxt}
                            initial={'hidden'}
            ...
            <div className="GroupParallax parallaxgroup">
                <div className="parallaxlayer farlayer mgntop80">
                    <motion.div 
                        variants={variantsimg} 
                        initial={'hidden'}
                        whileInView={'visible'}
                ...
                <div className="parallaxlayer caplayer">
                    <div className='flexpaneldisplay'>
                        <div className='topLayeritembtn'>
                            <Link href="/pages/MedicineJourneyD" className="apptextB" style={{textDecoration:'none'}}>
                                <Image
                                    src="/Mile20IV.jpg"
                                    alt="MenuBKG"
                                    width={300}
...
export default CominghomecontentD;
