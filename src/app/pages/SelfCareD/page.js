        ...
        return(
            <div className='row1fr1fr' style={{height:"100dvh"}}>
                ...
                <div className='flexpaneldisplay2' style={{height:"100dvh"}}>
                    <Link className='apptxtHugeB' style={{textDecoration:'none'}} href={"/pages/SelfCareD/" + "naturallaws"}>
                        <h1>The Natural Laws</h1> 
                    </Link>
                            
                    <Link className='apptxtHugeB' style={{textDecoration:'none'}} href={"/pages/SelfCareD/" + "socialroles"}>
                        <h1>Social Roles</h1>
                    </Link>
